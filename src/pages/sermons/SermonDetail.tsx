...
import SermonParticipantTable from "./SermonParticipantTable";
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="bg-white shadow-lg rounded-sm border border-gray-200 relative">
              ...
              <section className="px-5 py-4">
                <div>
                  {sermon?.thumbnailURL ? (
                    <img src={sermon?.thumbnailURL ?? ""} alt="sermon" />
                  ) : null}
                </div>
                <div className="my-2">
                ...
                <div className="mt-5 mb-2 flex flex-row justify-between">
                  <div>
                    <span className="text-gray-600">Sermon Date:</span>
                  </div>
                  <div>
                    <span className="text-gray-800">
                      {new Date(sermon?.sermonDate).toLocaleString("ID-id")} -{" "}
                    </span>
                    <span className="text-gray-800">
                      {new Date(sermon?.sermonEndDate).toLocaleString("ID-id")}
                    </span>
                  </div>
                </div>
                <div className="mt-5 mb-2 flex flex-row justify-between">
                ...
                <div className="mt-5 mb-2 flex flex-row justify-between">
                  <div>
                    <span className="text-gray-600">Max Quota:</span>
                  </div>
                  <div>
                    <span className="text-gray-800">
                      {sermon?.maxQuota ?? 0}
              ...
              <section className="px-5 py-4">
                <SermonParticipantTable sermonId={sermon?._id} />
              </section>
