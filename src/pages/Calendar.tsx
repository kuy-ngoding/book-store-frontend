                ...
                {dayNames.map((day) => {
                  return (
                    <div className="px-1 py-3" key={day}>
                      ...
                      <div className="text-gray-500 text-sm font-medium text-center hidden lg:block">
                        {day}
                      </div>
                    </div>
                  );
              ...
              <div className="grid grid-cols-7 gap-px bg-gray-200">
                ...
                <svg className="sr-only">
                  <defs>
                    ...
                    >
                      <line
                        className="stroke-current text-gray-200 opacity-50"
                        x1="0"
                        y="0"
                        x2="0"
                        y2="5"
                ...
                {startingBlankDays.map((blankday) => {
                  return (
                    <div
                      className="bg-gray-50 h-20 sm:h-28 lg:h-36"
                      key={blankday}
                    >
                      <svg
