...
import { useGetAllDevicesQuery } from "../../modules/devices/device.api";
import { Device } from "../../modules/devices/device.types";
...
function DeviceList() {
  ...
  const devicesColumns = React.useMemo<Column<Device>[]>(
    () => [
      {
        Header: "Name",
        accessor: "deviceName",
        ...
        Cell: ({ row }) => (
          <div>
            ...
            <Link
              ...
              aria-label="edit"
              to={`/subscription/devices/edit/${row.original._id}`}
            >
              <FaEdit />
            </Link>
            <button
