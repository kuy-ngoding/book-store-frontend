...
import { useCreateCompanyMutation } from "../../modules/company/api/company.api";
...
function CompanyAdd() {
  ...
  const [createCompany, createCompanyProcess] = useCreateCompanyMutation();
  ...
  const handleSubmit = async (formValue: Company) => {
    try {
      ...
      setTimeout(() => {
        toast.success(`${formValue.companyName} Created!`, {
          theme: "dark",
        });
      }, 0.1);
